...
\begin{enumerate}
  \item I've modified the OCaml compiler driver (\lstinline!driver/compile.ml!) to teach it about compiling to C. See section \ref{modified-compiler-driver};
...
\begin{itemize}
    \item preserve type information from \lstinline!Typedtree!. This is annoying
        ...
        \lstinline!liballocs! to use. See section
        \ref{type-information-for-liballocs};
    ...
    expressed as complete applications. See section
    \ref{closures-compiler-support}.
\end{itemize}
