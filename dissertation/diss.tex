...
with elements of type \lstinline{int}.
...
#define NEW_D(v) ((ocaml_value_t){.i = __double_encode(v)})\end{lstlisting}
    ...
    \item \lstinline!GET_I!, \lstinline!GET_D!, and \lstinline!GET_P! allow us to
        ...
        as:
        \begin{lstlisting}
#define GET_D(v) (__double_decode((v).i))\end{lstlisting}
    ...
    \item \lstinline!IS_I!, \lstinline!IS_D!, and \lstinline!IS_P! allow us to
        ...
        \lstinline{ocaml_value_t}. This is done by simple integer range tests -- for instance:
        \begin{lstlisting}
#define IS_I(v) ((uintptr_t) (v).i >= 0xfffc000000000000ULL)\end{lstlisting}
\end{enumerate}
