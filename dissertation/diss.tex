  ...
  \item
    ...
    \begin{itemize}
        \item Variable names. Two different kinds are distinguished:
          \begin{itemize}
            \item \lstinline!C_Variable of Ident.t! takes an identifier (see
            ...
            \item \lstinline!C_GlobalVariable of string! takes a string and
              ...
              functions, such as \lstinline!ocaml_liballocs_close! (see
	...
	\item
        ...
        possible in my AST -- as described below \ref{c-inline-statements} and \ref{c-inline-functions}.)
...
\begin{enumerate}
  ...
  \item \lstinline!Lfor! -- see \ref{for-loops}
  \item \lstinline!Ltrywith!, \lstinline!Lstaticcatch!, \lstinline!Lstaticraise! -- see \ref{exceptions}
...
See \ref{module-fixup} for more details.
...
all unit tests\footnote{At the end of my project, there were two expected failures: overapplication and submodule function arity inference, as described in \ref{conclusion}} -- works in progress were done on a separate branch before
