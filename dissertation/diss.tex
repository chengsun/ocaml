...
the OCaml compiler, as it is the starting point for our compiler.
...
which builds three (TODO: four?) versions of each benchmark:

\begin{itemize}
    \item \lstinline!ocamlc! upstream bytecode compiler;
    \item \lstinline!ocamlopt! upstream native compiler (TODO);
...
The \lstinline!fibonacci! benchmark was adapted from the corresponding
benchmark in \lstinline!operf-micro!.
